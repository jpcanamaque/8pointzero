...
<?php
// Multiple recipients
$to = 'jeffrybordeos@gmail.com'; // note the comma
...
// Additional headers
$headers[] = 'To: Mary <jeffrybordeos@gmail.com>';
...
<body>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            <h3>ABOUT US</h3>
            <p class="font-italic">
              8pointzero is a spin-off group of a mixture of professionals from different fields of Engineering, Computer Science, Digital Arts and Marketing. We take pride that our talents are home-grown and our software products are in-house developed from scratch. We are a team of creative and logical thinkers.
            </p>
          </div>
        </div>
              ...
              <div class="member-img" style="text-align:center">
                ...
                <div class="social">
                 <!--  <a href="#"><i class="bi bi-twitter"></i></a>
                  ...
                  <a href="https://www.linkedin.com/in/roy-catimbang"><i class="bi bi-linkedin"></i></a>
                </div>
              </div>
              ...
              <div class="member-img" style="text-align:center">
                ...
                <div class="social">
                 <!--  <a href="#"><i class="bi bi-twitter"></i></a>
                  <a href="#"><i class="bi bi-facebook"></i></a>
                  <a href="#"><i class="bi bi-instagram"></i></a> -->
                  <a href="https://www.linkedin.com/in/kevin-jay-roluna-61b060a7"><i class="bi bi-linkedin"></i></a>
                </div>
              </div>
              <div class="member-info" style="text-align: center;">
                <div class="mbr-author-name mbr-bold mbr-fonts-style display-7">Kevin</div>
                  <small class="mbr-author-desc mbr-italic mbr-light mbr-fonts-style display-7">
                      Founder
                  </small>
                  <small class="mbr-author-desc mbr-italic mbr-light mbr-fonts-style display-7">
              ...
              <div class="member-img" style="text-align:center">
                ...
                <div class="social">
                 <!--  <a href="#"><i class="bi bi-twitter"></i></a>
                  <a href="#"><i class="bi bi-facebook"></i></a>
                  <a href="#"><i class="bi bi-instagram"></i></a> -->
                  <a href="https://www.linkedin.com/in/jeffrybordeos"><i class="bi bi-linkedin"></i></a>
                </div>
              </div>
              <div class="member-info" style="text-align: center;">
                <div class="mbr-author-name mbr-bold mbr-fonts-style display-7">Jeff</div>
                  <small class="mbr-author-desc mbr-italic mbr-light mbr-fonts-style display-7">
                      Founder
                  </small>
                  <small class="mbr-author-desc mbr-italic mbr-light mbr-fonts-style display-7">
              ...
              <div class="member-img" style="text-align:center">
                ...
                <div class="social">
                 <!--  <a href="#"><i class="bi bi-twitter"></i></a>
                  <a href="#"><i class="bi bi-facebook"></i></a>
                  <a href="#"><i class="bi bi-instagram"></i></a> -->
                  <a href="https://www.linkedin.com/in/jpcanamaque"><i class="bi bi-linkedin"></i></a>
                </div>
              </div>
              <div class="member-info" style="text-align: center;">
                <div class="mbr-author-name mbr-bold mbr-fonts-style display-7">Paulo</div>
                  <small class="mbr-author-desc mbr-italic mbr-light mbr-fonts-style display-7">
                      Founder
                  </small>
                  <small class="mbr-author-desc mbr-italic mbr-light mbr-fonts-style display-7">
          ...
          <div class="col-lg-4">
            <div class="info">
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>roy.catimbang@8pointzero.com</p>
              </div>
  ...
  <footer id="footer">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <p>
                Cavite <br>
                Philippines<br><br>
                <strong>Phone:</strong> +63 977 802 8869<br>
                <strong>Email:</strong> roy.catimbang@8pointzero.com<br>
              </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>8POINTZERO</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
